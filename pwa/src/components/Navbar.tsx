...
import { Timer as TimerIcon, Calendar, BarChart2, Moon, Sun, Bell } from 'lucide-react';
      ...
      <div className="max-w-md mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2.5">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] uppercase tracking-widest text-zen-muted -mt-1 font-semibold">Habit & Focus</span>
          </div>
        </div>
...
export const BottomNavbar: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-30 bg-zen-surface/90 backdrop-blur-lg border-t border-zen-border safe-bottom transition-colors">
